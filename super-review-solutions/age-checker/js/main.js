...
document.querySelector('h1').addEventListener("click",function(){  
    console.log("age")
    const age = Number(document.querySelector
    ...
    if(age<16){
        ...
        para.textContent = "hey can not rent cars affordably"
    }
    else if(age<30){
        para.textContent = "they can not rent fancy cars affordably"
    }
    else {
        para.textContent = "there is nothing left to look forward too other then 100Devs"
    }
